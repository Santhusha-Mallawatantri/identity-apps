...
export const extensions: Extensions = {
    ...
    develop: {
        apiResource: {
            pageHeader: {
                description: "ඔබගේ API සම්පත් ලියාපදිංචි කර කළමනාකරණය කරන්න",
                title: "API සම්පත්"
            },
            ...
            tabs: {
                ...
                general: {
                    ...
                    form: {
                        fields: {
                            name: {
                                emptyValidate: "නම හිස් විය නොහැක",
                                label: "නම",
                ...
                permissions: {
                    ...
                    form: {
                        ...
                        title: "අවසර එකතු කරන්න",
                        subTitle: "නව අවසර සාදන්න",
                        fields: {
                            permission: {
                                emptyValidate: "අවසරය හිස් විය නොහැක",
                                label: "අවසර",
                                placeholder: "අවසරය ඇතුළත් කරන්න"
                            },
                            description: {
                                label: "විස්තර",
                            ...
                            form: {
                                fields: {
                                    ...
                                    identifier: {
                                        ...
                                        hint: "[Text description for identifier]",
                                        label: "හඳුනාගැනුම",
                                        placeholder: "API සම්පතේ හඳුනාගැනීමට ඇතුළත් කරන්න"
                                    },
                                    description: {
                                        label: "විස්තර",
                                        placeholder: "API සම්පත සඳහා විස්තරයක් ඇතුළත් කරන්න"
        ...
        identityProviders: {
            ...
            smsOTP: {
                settings: {
                    ...
                    enableRequiredNote: {
                        message: "SMS OTP සක්‍රීය කිරීම සදහා Asgardeo විසින් <1>Choreo</1> වෙත සිදුවීම් පල කරන අතර, බහු " +
                            "සේවාවන් හා ඒකාබද්ධව OTP දැන්වීම් පලකර ගැනීමට Choreo webhooks භවිතා කරයි. මෙම සේවාව වින්‍යාස " +
                            "කරගැනීම සදහා <3>Add SMS OTP</3> ලේකනය අනුගමනය කරන්න."
                    },
                    errorNotifications: {
        ...
        sidePanel: {
            ...
            eventPublishing :"සිදුවීම් ප්‍රකාශනය"
        },
        eventPublishing: {
            heading: "සිදුවීම් ප්‍රකාශනය",
            subHeading: "සිදුවීම් ප්‍රකාශන සම්බන්ධ සැකසුම්.",
            connectors: {
                eventsConfiguration : {
                    heading: "සිදුවීම් වින්‍යාසය",
                    subHeading: "Asgardeo සිදුවීම් සඳහා ප්‍රකාශන සිදුවීම් සබල කරන්න."
                }
            },
            eventsConfiguration: {
                heading: "සිදුවීම් වින්‍යාස කරන්න",
                subHeading:  "සිදුවීම් ප්‍රකාශනය සක්‍රීය කළ විට, Asgardeo සිදුවීම් Choreo වෙත ප්‍රකාශයට පත් කෙරේ. ක්‍රියා අවුලුවාලීමට සහ විශ්ලේෂණ සඳහා ඔබට මෙම සිදුවීම් භාවිත කළ හැක.",
                backButton: "සිදුවීම් ප්‍රකාශනය වෙත ආපසු යන්න",
                form : {
                    updateButton: "Update"
                },
                navigateToChoreo: {
