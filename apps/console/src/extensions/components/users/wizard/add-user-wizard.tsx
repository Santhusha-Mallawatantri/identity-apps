...
import { PatchRoleDataInterface, updateRoleDetails } from "../../../../features/roles";
import {
...
import { generatePassword } from "../../../../features/users/utils";
...
export const AddUserWizard: FunctionComponent<AddUserWizardPropsInterface> = (
    ...
    const addUserBasic = (userInfo: AddUserWizardStateInterface) => {
        const userName: string = userInfo.domain + "/" + userInfo.email;
        ...
        return {
            content: (
                <AddUserWizardSummary
                    ...
                    username={ wizardState[ WizardStepsFormTypes.BASIC_DETAILS ]?.email }
