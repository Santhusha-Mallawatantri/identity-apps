...
import { SearchRoleInterface, getRoleById, searchRoleList } from "../../../../features/roles";
...
const CollaboratorsPage: FunctionComponent<CollaboratorsPageInterface> = (
    ...
    const transformUserList = (usersList: UserListInterface): UserListInterface => {
        ...
        clonedUserList.Resources = processedUserList.concat(clonedUserList.Resources)
            .filter((user: UserBasicInterface) => user !== undefined);
            ...
            <div className="mt-0 mb-1">
                {
                    <SemanticMessage
                        style={ {
                            borderRadius: "4px",
                            boxShadow: "0 0 0 1px rgb(34 36 38 / 22%) inset, 0 0 0 0 transparent !important"
                        } }
                ...
                }
                {
                    (invitationStatusOption === InvitationStatus.PENDING) && (
                        <GuestUsersList
                            ...
                            isGuestUsersRequestLoading={ isGuestUserListFetchRequestLoading }
                            searchQuery={ searchQuery }
                        />
                    )
                }
