...
export const applicationConfig: ApplicationConfig = {
    ...
    editApplication: {
        ...
        getTabExtensions: (
            ...
            const applicationRolesFeatureEnabled: boolean =
                (features as ExtendedFeatureConfigInterface)?.applicationRoles?.enabled;
            ...
            if (
                content && application?.templateId !== CustomApplicationTemplate.id
            ...
            // Enable the roles tab for only applications with choreo app template ID.
            // This will be added to all apps once Asgardeo fully supports API resource registration.
            if (
                applicationRolesFeatureEnabled
                && application?.templateId === ApplicationRolesConstants.CHOREO_APP_TEMPLATE_ID
            ) {
                tabExtensions.push(
                    {
