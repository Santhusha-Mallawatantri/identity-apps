...
const CustomIdentityProviderCreateWizardHelpPropsInterface = () => {
 ...
 */
CustomIdentityProviderCreateWizardHelpPropsInterface.defaultProps = {
 ...
 */
export default CustomIdentityProviderCreateWizardHelpPropsInterface;
